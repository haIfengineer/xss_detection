...
echo "[*] XSS Finder:- Automated Cross-Site Scripting Vulnerabilities Detection Tool [*]"
echo "			 [*] A project by Sanket Kumar [*]"
...
cat gxss.txt | dalfox pipe | tee -a dalfox.txt


echo "[*] Thank You For Using This Automated Tool [*] "
